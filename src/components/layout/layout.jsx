...
const items = [
    ...
    { name: "¿Qué es el Hub?", route: "/projects/hub-de-inovacion#quienes-somos", subitems: [{ route: "/projects/hub-de-inovacion", name: "subitem 1" }, { route: "/projects/hub-de-inovacion", name: "subitem 2" }, { route: "/projects/hub-de-inovacion", name: "subitem 3" }, { route: "/projects/hub-de-inovacion", name: "subitem 4" }] },
